# PumpkinOnFencePlugin #
### Pumpkin on fence placement plugin ###
#### &copy; Copyright 2012-2013 Visual Illusions Entertainment ####
#### Licensed under the GNU General Public License v3 ####

## About ##
See the [PumpkinOnFencePlugin Wiki Page](http://wiki.visualillusionsent.net/PumpkinOnFencePlugin "wiki_PumpkinOnFencePlugin") for more information

## Bug Reporting ##
Please use the [GitHub issue tracker](https://github.com/Visual-Illusions/PumpkinOnFencePlugin/issues "issues") associated with this repository.<br/>
...
PumpkinOnFencePlugin is free software: you can redistribute it and/or modify it<br/>
